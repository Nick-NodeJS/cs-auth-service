...
pub fn set_value_with_ttl(connection: &mut Connection, key: &str, value: &str, milliseconds: usize) -> Result<(), RedisError> {
...
pub fn get_value(connection: &mut Connection, key: &str) -> Result<Option<String>, RedisError> {
  //let mut connection = self.client.get_connection()?;
